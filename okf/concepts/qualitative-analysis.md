...
description: Design contract for the grounded AI qualitative layer that enriches AIMS reports while the quantitative pipeline remains the source of deterministic market scores.
type: concept
tags: [qualitative-analysis, market-analysis, grounding]
